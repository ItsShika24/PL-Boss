...
// Ganti pengecekan session dari admin_id menjadi user_id + role
...
<head>
    ...
    <style>
        ...
        .admin-badge { background: #ff6b6b; color: white; padding: 3px 8px; border-radius: 12px; font-size: 12px; margin-left: 5px; }
    </style>
</head>
<body>
    <div class="navbar">
        <h2>🎬 Admin Bioskop</h2>
        <div>
            <span>Halo, <?= $_SESSION['user_nama'] ?> <span class="admin-badge">ADMIN</span></span>

...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE film SET nama=:nama, deskripsi=:deskripsi, genre=:genre, 
            harga=:harga, durasi=:durasi, poster=:poster, jadwal_tayang=:jadwal_tayang WHERE id_film=:id";
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <select name="jadwal_tayang" required>
                    <option value="Sekarang Tayang" <?= $film['jadwal_tayang']=='Sekarang Tayang'?'selected':'' ?>>Sekarang Tayang</option>
                    <option value="Akan Tayang" <?= $film['jadwal_tayang']=='Akan Tayang'?'selected':'' ?>>Akan Tayang</option>
                    <option value="Selesai Tayang" <?= $film['jadwal_tayang']=='Selesai Tayang'?'selected':'' ?>>Selesai Tayang</option>
                </select>
            </div>

...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO film (nama, deskripsi, genre, harga, durasi, poster, jadwal_tayang) 
            VALUES (:nama, :deskripsi, :genre, :harga, :durasi, :poster, :jadwal_tayang)";
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="jadwal_tayang" required>
                    <option value="">-- Pilih --</option>
                    <option value="Sekarang Tayang">Sekarang Tayang</option>

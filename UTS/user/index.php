...
<head>
    ...
    <style>
        body { font-family: Arial; margin: 0; background: linear-gradient(135deg, #667eea 20%, #764ba2 80%); }
        .navbar { background: #ffffff; color: #5568d3; padding: 15px 30px; display: flex; justify-content: space-between; align-items: center; }
        .navbar h2 { margin: 0; }
        .nav-links a { color: #5568d3; text-decoration: none; margin: 0 10px; padding: 8px 15px; border-radius: 5px; }
        ...
        .welcome { background: #ffffff; color: white; padding: 30px 200px; text-align: center; border-radius: 30px; width: fit-content; margin: 20px auto; }
        .welcome h1 { color: #5568d3; margin-bottom: 10px; }
        .welcome p { color: #667eea; font-size: 18px; }
